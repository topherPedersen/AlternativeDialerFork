...
package com.phponacid.dialer.filterednumber;
...
import com.phponacid.contacts.common.util.ContactDisplayUtils;
...
import com.phponacid.dialer.voicemail.VisualVoicemailEnabledChecker;
...
public class BlockNumberDialogFragment extends DialogFragment {
    ...
    private void blockNumber() {
        ...
        final FilteredNumberAsyncQueryHandler.OnUnblockNumberListener onUndoListener = new FilteredNumberAsyncQueryHandler.OnUnblockNumberListener() {
            @Override
        ...
        final FilteredNumberAsyncQueryHandler.OnBlockNumberListener onBlockNumberListener = new FilteredNumberAsyncQueryHandler.OnBlockNumberListener() {
            @Override
    ...
    private void unblockNumber() {
        ...
        final FilteredNumberAsyncQueryHandler.OnBlockNumberListener onUndoListener = new FilteredNumberAsyncQueryHandler.OnBlockNumberListener() {
            @Override
            public void onBlockComplete(final Uri uri) {
                Snackbar.make(mParentView, undoMessage, Snackbar.LENGTH_LONG).show();
                if (callback != null) {
        ...
        mHandler.unblock(new FilteredNumberAsyncQueryHandler.OnUnblockNumberListener() {
            @Override
