...
import com.phponacid.dialer.contactinfo.ContactPhotoLoader;
import com.phponacid.dialer.compat.UserManagerCompat;
...
public class MissedCallNotifier {
    ...
    public void updateMissedCallNotification(int count, String number) {
        ...
        final List<CallLogNotificationsHelper.NewCall> newCalls =
        ...
        CallLogNotificationsHelper.NewCall newestCall = useCallLog ? newCalls.get(0) : null;
