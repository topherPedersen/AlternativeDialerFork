...
import com.phponacid.contacts.common.CallUtil;
import com.phponacid.contacts.common.ClipboardUtils;
import com.phponacid.contacts.common.ContactPhotoManager;
import com.phponacid.contacts.common.ContactPhotoManager.DefaultImageRequest;
import com.phponacid.contacts.common.GeoUtil;
import com.phponacid.contacts.common.compat.CompatUtils;
import com.phponacid.contacts.common.interactions.TouchPointManager;
import com.phponacid.contacts.common.preference.ContactsPreferences;
import com.phponacid.contacts.common.testing.NeededForTesting;
import com.phponacid.contacts.common.util.UriUtils;
import com.phponacid.dialer.calllog.CallDetailHistoryAdapter;
import com.phponacid.dialer.calllog.CallLogAsyncTaskUtil;
import com.phponacid.dialer.calllog.CallTypeHelper;
import com.phponacid.dialer.calllog.ContactInfoHelper;
import com.phponacid.dialer.calllog.PhoneAccountUtils;
import com.phponacid.dialer.compat.FilteredNumberCompat;
import com.phponacid.dialer.database.FilteredNumberAsyncQueryHandler;
import com.phponacid.dialer.filterednumber.BlockNumberDialogFragment;
import com.phponacid.dialer.filterednumber.FilteredNumbersUtil;
import com.phponacid.dialer.logging.InteractionEvent;
...
import com.phponacid.dialer.util.PhoneNumberUtil;
import com.phponacid.dialer.util.TelecomUtil;
import com.phponacid.incallui.Call.LogState;
